          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/projects" className="inline-flex items-center px-6 py-3 rounded-lg text-white font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg" style={{
                ...
                <Link to="/contact" className="inline-flex items-center px-6 py-3 border-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500">
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            value: '10+'
          }].map((stat, index) => <div key={index} className="text-center animate-fade-in">
                <div className="text-3xl font-bold text-gray-900 dark:text-white mb-2" style={{
              color: primaryColor
            }}>
                  {stat.value}
                </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {['Python', 'Java', 'JavaScript', 'SQL', 'React', 'Pandas'].map((skill, index) => <div key={index} className="bg-white dark:bg-gray-900 p-4 rounded-lg text-center shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105">
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://github.com/Sridattasai18" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 rounded-lg text-white font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg" style={{
            backgroundColor: primaryColor
          }}>
